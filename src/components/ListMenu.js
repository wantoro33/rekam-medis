const listMenu = [
	{ name: 'master',
	  ...
	  items: [
        ...
        'divider',
		{ name: 'kelLayananLab', label: 'Kelompok Layanan Lab', target: '/kellayanlab' },
		...
		{ name: 'keluargaKaryawan', label: 'Keluarga Karyawan', target: '/keluargakaryawan' },
	  ],
    },
    'divider',
	{ name: 'data', 
	  ...
	  items: [
		...
		{ name: 'inputHasilLab', label: 'Input Pemeriksaan Hasil Lab', target: '/inputhasillab' },
	  ],
    },
    'divider',
	{ name: 'stock', 
	  ...
	  items: [
		...
		{ name: 'pakaiObatNonResep', label: 'Pemakaian Obat Non Resep', target: '/pakaiobatnonresep' },
	...
	{ name: 'laporan',
	  label: 'Laporan',
	  items: [
		{ name: 'riwayatRMPasien', label: 'Riwayat Rekam Medis Pasien', target: '/riwayatrmpasien' },
		{ name: 'kunjunganPoli', label: 'Kunjungan Poliklinik', target: '/kunjunganpoli' },
		{ name: 'penyakitTerbesar', label: '10 Penyakit Terbesar', target: '/penyakitterbesar' },
